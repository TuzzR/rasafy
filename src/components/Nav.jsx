  ...
  return (
    <>
      <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
        <nav
          class="relative max-w-7xl flex flex-wrap basis-full items-center w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
          aria-label="Global"
        >
          <div class="flex items-center justify-between">
            <a
              class="flex-none text-xl font-semibold dark:text-white"
              href="https://www.euphoricthought.com"
              aria-label="Brand"
            >
          ...
          <div class="flex items-center ml-auto sm:ml-0 sm:order-3">
            ...
            <div class="pl-3 sm:pl-6 sm:ml-6 sm:border-l sm:border-gray-300 dark:border-gray-700">
              ...
              >
                ...
                <svg
                  class="hs-overlay-open:block hidden w-4 h-4"
                  width="16"
                  height="16"
                  fill="currentColor"
                  viewBox="0 0 16 16"
          ...
          >
            <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
              <a
                class="font-medium text-blue-600 px-6 sm:py-6 sm:px-0 dark:text-blue-500"
                href="#"
                aria-current="page"
              >
                Landing
              ...
              <a
                class="font-medium text-gray-500 hover:text-gray-400 px-6 sm:py-6 sm:px-0 dark:text-gray-400 dark:hover:text-gray-500"
                href="#"
              >
                Account
              </a>
